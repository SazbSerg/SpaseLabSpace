...
public class Sorting {
    ...
    public static void quickSort(int[] arr, int from, int to) { // создание метода и подача на вход
        // целочисленного массива и начальной-конечной точек сортировки
